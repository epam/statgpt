...
| **[🔌 Application MCP](../mcp/README.md)**           | Programmatic tool access via Model Context Protocol       | • Channel tools over MCP<br>• DIAL Application registration<br>• MCP-spec discovery + IDP OAuth flow                   |
