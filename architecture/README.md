...
| **[📐 SDMX Data Models](./sdmx-data-models.md)**     | SDMX data-model patterns and which StatGPT supports       | • Conventional (supported)<br>• Shared DSD (supported, not optimal)<br>• Indicator-per-dataflow (not yet)<br>• Why indicator search fits one model |
